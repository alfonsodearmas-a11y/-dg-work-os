      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[#64748b] mt-1 text-xs md:text-sm">AI-powered meeting minutes</p>
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        >
          {syncing ? (
            ...
            <><RefreshCw className="h-4 w-4" /> <span className="hidden md:inline">Sync Meetings</span></>
          )}
        </button>
      </div>
      ...
      <div className="flex items-center gap-2 flex-wrap">
        {([
          ...
          { key: 'pending', label: 'Pending', tip: 'Imported, waiting to be processed' },
          { key: 'failed', label: 'Failed', tip: 'AI processing hit an error — can be retried' },
          { key: 'skipped', label: 'Skipped', tip: 'Page had no transcript or too little text' },
        ...
        <div className="card-premium p-12 text-center">
          ...
          <p className="text-[#64748b] text-sm mb-4">
            {statusFilter
              ...
              : 'Click "Sync Meetings" to import your meetings.'}
          </p>
          {!statusFilter && (
            <button
              onClick={handleSync}
            ...
            >
              <RefreshCw className="h-4 w-4" /> Sync Meetings
            </button>
          )}
        </div>
      ) : (
