...
import { getGWIInsightsForMonth } from '@/lib/gwi-insights';
...
export async function GET(
  ...
  try {
    ...
    const insights = await getGWIInsightsForMonth(normalizedMonth);
    ...
    logger.error({ err, month }, 'GWI insights fetch failed');
