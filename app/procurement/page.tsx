...
import { ArrowLeft, ShoppingCart, LayoutDashboard, BarChart3, Plus } from 'lucide-react';
      ...
      <div className="flex items-center flex-wrap gap-3 md:gap-4">
        ...
        {canCreate && (
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-semibold bg-gold-500 text-navy-950 hover:bg-[#e5c348] transition-colors shrink-0"
          >
