...
export const ALL_STATUSES: TaskStatus[] = ['new', 'active', 'blocked', 'done', 'awaiting_verification', 'superseded'];
...
export const STATUS_CONFIG: Record<TaskStatus, { label: string; color: string }> = {
  ...
  awaiting_verification: { label: 'Awaiting Verification', color: 'bg-purple-500' },
