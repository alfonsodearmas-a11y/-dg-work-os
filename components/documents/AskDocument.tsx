    ...
    <div className="space-y-4">
      ...
      <div className="flex space-x-3">
        <div className="flex-1 relative">
          ...
          />
          <Sparkles className="absolute right-4 top-3.5 h-5 w-5 text-gold-500/50" />
        </div>
        <button
          onClick={handleAsk}
      ...
      {queries.length > 0 && (
        <div className="mt-6">
          <button
            ...
            className="text-sm font-medium text-navy-600 mb-4 flex items-center hover:text-slate-400 transition-colors"
          >
          ...
          {showHistory && (
            <div className="space-y-4">
              {queries.map((query) => (
                <div key={query.id} className="border-l-2 border-navy-800 pl-4 space-y-2">
                  ...
                  <div className="text-sm prose-invert prose-sm max-w-none
                    ...
                    [&_ul]:text-slate-400 [&_ul]:ml-4 [&_ul]:list-disc
                    [&_ol]:text-slate-400 [&_ol]:ml-4 [&_ol]:list-decimal
                    [&_strong]:text-white
                    [&_code]:text-gold-500 [&_code]:bg-navy-900 [&_code]:px-1 [&_code]:rounded [&_code]:text-xs
                  ">
