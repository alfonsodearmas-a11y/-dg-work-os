...
import { X, Calendar, CheckSquare, FileText, Building2, BarChart3, Eye, UserCheck } from 'lucide-react';
    ...
    >
      ...
      <div className="flex items-start gap-3 p-3 pl-4">
        <div className="mt-0.5 flex-shrink-0">
          <ToastIcon type={notification.type} category={notification.category} />
        </div>
