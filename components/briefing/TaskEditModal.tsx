...
export function TaskEditModal({ task, onClose, onSave }: TaskEditModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-[#0f1d32] border border-[#2d3a52] rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#2d3a52] bg-gradient-to-r from-[#1a2744] to-[#0f1d32]">
        ...
        {/* Footer */}
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-[#2d3a52] bg-[#1a2744]/50">
          <button
            onClick={onClose}
